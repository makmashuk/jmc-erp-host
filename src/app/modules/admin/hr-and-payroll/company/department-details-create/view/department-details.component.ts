...
} from 'app/store/actions/company/department-details.actions';
...
import {
    ...
    isDepartmentLoading,
    isDepartmentUpdated,
} from 'app/store/selectors/company/department-details.selector';
    ...
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    public dataSource$: Observable<DepartmentDetails[]>;
    ...
    constructor(
        ...
        this.totalDataCount$ = this._store.select(getDepartmentCount);
        this.dataLoading$ = this._store.select(isDepartmentLoading);
    }
    ...
    ngOnInit(): void {
        ...
        this.dataSource$ = this._store.select(getDepartmentList);
        ...
        this._store.dispatch(new GetListOfDepartments(1, 10));
    ...
    onCreate() {
        ...
        this._store.dispatch(new CreateNewDepartmentDetails(formInfo));
    ...
    onEdit() {
        ...
        this._store.dispatch(new UpdateDepartmentDetails(updated_data));
    ...
    onDelete() {
        ...
        this.isLoading = true;
        this._store.dispatch(new DeleteDepartmentDetails(id));
        this.handleCloseModal();
    }
