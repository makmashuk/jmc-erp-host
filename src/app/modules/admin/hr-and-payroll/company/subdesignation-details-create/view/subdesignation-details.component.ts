...
} from 'app/store/actions/company/subdesignation-details.actions';

// @selector
import {
    getSubDesignationCount,
    getSubDesignationList,
    isSubDesignationCreated,
    isSubDesignationDeleted,
    isSubDesignationLoading,
    isSubDesignationUpdated,
} from 'app/store/selectors/company/subdesignation-details.selector';
...
import { GetListOfDesignations } from 'app/store/actions/company/designation-details.actions';

@Component({
    selector: 'app-subdesignation-details',
    templateUrl: './subdesignation-details.component.html',
    styleUrls: ['./subdesignation-details.component.scss'],
})
export class SubDesignationDetailsComponent
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    public designationList$: Observable<any>;
    public isDataLoading: boolean = false;
    public dataLoading$: Observable<boolean>;
    public totalDataCount$: Observable<number>;
    public dataSource$: Observable<SubDesignationDetails[]>;
    ...
    constructor(
        ...
        this.totalDataCount$ = this._store.select(getSubDesignationCount);
        this.dataLoading$ = this._store.select(isSubDesignationLoading);
    }
    ...
    ngOnInit(): void {
        ...
        this.dataSource$ = this._store.select(getSubDesignationList);

        this.designationList$ = this._store.select(getDesignationList);

        // this._store.dispatch(new GetListOfSubDesignations(1, 10));
        this._store.dispatch(new GetListOfSubDesignations());
    ...
    onCreate() {
        ...
        this._store.dispatch(new CreateNewSubDesignationDetails(formInfo));
    ...
    onEdit() {
        ...
        this._store.dispatch(new UpdateSubDesignationDetails(updated_data));
    ...
    onDelete() {
        ...
        this.isLoading = true;
        this._store.dispatch(new DeleteSubDesignationDetails(id));
        this.handleCloseModal();
    }
    ...
    handleCloseModal() {
        if (this.general_type === 'edit') {
            this._store
                .select(isSubDesignationUpdated)
            ...
            this._store
                .select(isSubDesignationDeleted)
            ...
            this._store
                .select(isSubDesignationCreated)
