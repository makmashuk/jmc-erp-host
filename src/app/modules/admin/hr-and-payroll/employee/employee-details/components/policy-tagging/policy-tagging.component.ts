...
@Component({
  selector: 'app-policy-tagging',
  templateUrl: './policy-tagging.component.html',
  styleUrls: ['./policy-tagging.component.scss']
})
export class PolicyTaggingComponent implements OnInit {
