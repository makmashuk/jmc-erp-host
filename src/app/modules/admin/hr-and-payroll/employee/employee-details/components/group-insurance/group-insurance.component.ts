...
@Component({
  selector: 'app-group-insurance',
  templateUrl: './group-insurance.component.html',
  styleUrls: ['./group-insurance.component.scss']
})
export class GroupInsuranceComponent implements OnInit {
  ...
  private _produceForm() {
    this.formInstance = this._formBuilder.group({
      ...
      nominee_name: [null, Validators.required],
