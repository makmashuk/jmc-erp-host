...
export class JobExperienceComponent implements OnInit {
  ...
  initializeData() {
    this._route.data.subscribe(res => {
      this.dataSource = res.jobInfo.data;
  ...
  onCreate() {
    ...
    this._employeeDetailsService.createJobInfo(formInfo).subscribe(res => {
  ...
  onEdit() {
    ...
    this._employeeDetailsService.updateJobInfo(this.modifiedDataId, formInfo).subscribe(res => {
  ...
  onDelete() {
    ...
    this._employeeDetailsService.deleteJobInfo(this.modifiedDataId).subscribe(res => {
  ...
  private _produceForm() {
    this.formInstance = this._formBuilder.group({
      ...
      resigning_date: [null, Validators.required],
